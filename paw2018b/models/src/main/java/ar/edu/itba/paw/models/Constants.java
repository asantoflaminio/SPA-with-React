...
public class Constants {
	...
	public static enum Role {
		USER("USER"), ADMIN("ADMIN"), LOCKED("LOCKED");
	...
	public static enum Location {
		PROVINCE("Province"), CITY("City"), NEIGHBORHOOD("Neighborhood");
	...
	public static enum DataBaseFilterName {
		OPERATION("operation"), PROPERTYTYPE("propertyType"), PRICE("price"), FLOORSIZE("floorSize"),
		BEDROOMS("bedrooms"), BATHROOMS("bathrooms"), PARKING("parking"), LOCKED("locked");
	...
	public static enum QueryFilterName {
		OPERATION("operation"), PROPERTYTYPE("propertyType"), MINPRICE("minPrice"), MAXPRICE("maxPrice"),
		MINFLOORSIZE("minFloorSize"), MAXFLOORSIZE("maxFloorSize"), BEDROOMS("bedrooms"), BATHROOMS("bathrooms"),
		PARKING("parking"), LOCKED("locked");
	...
	public static enum QueryOrder {
		NO_ORDER("No order"), ASCENDANT_ORDER("Ascending order"), DESCENDANT_ORDER("Descending order"),
		OLDEST_PUBLICATION("Oldest publications"), NEWEST_PUBLICATION("Newest publications");
