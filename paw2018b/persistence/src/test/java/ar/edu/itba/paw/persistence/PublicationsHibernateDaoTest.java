...
public class PublicationsHibernateDaoTest {
	...
	public void testCreate() {
		...
		final Publication pub2 = publicationDao.create(TITLE2, ADDRESS2, String.valueOf(n.getNeighborhoodid()),
				String.valueOf(c.getCityid()), String.valueOf(p.getProvinceid()), OPERATION2, PRICE2, DESCRIPTION2,
				PROPERTYTYPE2, BEDROOMS2, BATHROOMS2, FLOORSIZE2, PARKING2, COVEREDFLOORSIZE2, BALCONIES2, AMENITIES2,
				STORAGE2, EXPENSES2, user_id);
	...
	public void testEditData() {
		...
		publicationDao.editData(TITLE2, ADDRESS2, String.valueOf(n.getNeighborhoodid()), String.valueOf(c.getCityid()),
				String.valueOf(p.getProvinceid()), OPERATION2, PRICE2, DESCRIPTION2, PROPERTYTYPE2, BEDROOMS2,
				BATHROOMS2, FLOORSIZE2, PARKING2, COVEREDFLOORSIZE2, BALCONIES2, AMENITIES2, STORAGE2, EXPENSES2,
