...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				// LocationController
				.antMatchers(HttpMethod.POST, "/meinHaus/locations-management/provinces")
				.hasRole(Constants.Role.ADMIN.getRole())
				.antMatchers(HttpMethod.POST, "/meinHaus/locations-management/provinces/{provinceid}/cities")
				.hasRole(Constants.Role.ADMIN.getRole())
				.antMatchers(HttpMethod.POST, "/meinHaus/locations-management/cities/{cityid}/neighborhoods")
				.hasRole(Constants.Role.ADMIN.getRole())
				...
				.antMatchers(HttpMethod.GET, "/meinHaus/publications-management/publications/{publicationid}")
				.permitAll()
				.antMatchers(HttpMethod.GET, "/meinHaus/publications-management/publications/{publicationid}/images")
				.permitAll()
				.antMatchers(HttpMethod.POST, "/meinHaus/publications-management/publications/{publicationid}/images")
				.access("! hasRole('ROLE_LOCKED')")
				.antMatchers(HttpMethod.DELETE, "/meinHaus/publications-management/publications/{publicationID}")
				.hasRole(Constants.Role.ADMIN.getRole())
				...
				.antMatchers(HttpMethod.PATCH, "/meinHaus/users-management/users/{userid}/lock")
				.hasRole(Constants.Role.ADMIN.getRole())
				...
				.antMatchers(HttpMethod.POST, "/meinHaus/users-management/users/{userid}/publications")
				.access("! hasRole('ROLE_LOCKED')")
				...
				.antMatchers(HttpMethod.DELETE,
						"/meinHaus/users-management/users/{userid}/publications/{publicationid}")
				.authenticated()
				.antMatchers(HttpMethod.GET, "/meinHaus/users-management/users/{userid}/favourite-publications")
				.authenticated()
				.antMatchers(HttpMethod.POST, "/meinHaus/users-management/users/{userid}/favourite-publications")
				.authenticated()
				.antMatchers(HttpMethod.DELETE,
						"/meinHaus/users-management/users/{userid}/favourite-publications/{publicationid}")
				.authenticated();

		http.addFilterBefore(
				new StatelessLoginFilter("/meinHaus/users-management/login", tokenAuthenticationService,
						userDetailsService, userService, authenticationManager()),
				UsernamePasswordAuthenticationFilter.class)
				.addFilterBefore(new StatelessAuthenticationFilter(tokenAuthenticationService),
						UsernamePasswordAuthenticationFilter.class)
				.exceptionHandling().authenticationEntryPoint(new NotAuthorizedError()).and().exceptionHandling()
				.accessDeniedHandler(new ForbiddenError());

	}

	@Override
	public void configure(final WebSecurity http) throws Exception {
		http.ignoring().antMatchers("/**.js", "/**.css", "/**.jpg", "/**.png", "/**.gif", "/**.ico", "/**.svg")
