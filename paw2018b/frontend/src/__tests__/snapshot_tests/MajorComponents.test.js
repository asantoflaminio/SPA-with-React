...
describe('Details component', () => {
    ...
    it('renders with parameters correctly', () => {
        const rendered = shallow(<Details publication={publicationDTO} circleLoading={false} 
        error={null} loading={false} showModal={false} code={null}/>);
        expect(rendered).toMatchSnapshot();
    });
});
...
describe('List component', () => {
    ...
    it('renders with parameters correctly', () => {
        const rendered = shallow(<List loadingPublications={false} 
...
describe('Home component', () => {
    ...
    it('renders with parameters correctly', () => {
        const rendered = shallow(<Home loading={false} 
