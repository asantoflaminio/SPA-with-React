					...
					<div className='box_form_signUp'>
						...
						<Formik
							...
							{({values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting}) => (
								<Form
									noValidate
									onSubmit={(event) => handleSubmit(event) || this.handleSignUpForm(event, errors)}>
									...
									<Button type='submit' id='submitButtonSignUp' disabled={isSubmitting} onClick={handleChange}>
										{t('signUp.submit')}
									</Button>
								</Form>
							)}
					...
					<div className='box_form_signUp box_form_signUp-2'>
						...
						<Formik
							...
							{({values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting}) => (
								<Form
									noValidate
									onSubmit={(event) => handleSubmit(event) || this.handleLoginForm(event, errors)}>
									<Form.Group as={Col} md='12'>
										<Form.Label>{t('signUp.email')}</Form.Label>
										<Form.Control
											type='text'
									...
									<p id='errorLoginSignUp' className='errorText'>
										{t('errors.errorLogin')}
									</p>
									<Button type='submit' id='submitButtonLogIn' disabled={isSubmitting} onClick={handleChange}>
										{t('signUp.submit')}
									</Button>
								</Form>
							)}
