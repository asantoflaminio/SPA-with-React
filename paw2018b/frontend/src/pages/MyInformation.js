                        ...
                        <div className='Data'>
                            <div className='data polaroid'>
                                <h2 className='title_container'>
                                    {t('profile.titlePersonalData')} {this.state.myPublicationsCounter}
                                </h2>
                                <div className='form'>
                                    <hr />
                                    <Formik
                                        ...
                                        {({values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting}) => (
                                            <Form
                                                noValidate
                                                onSubmit={(event) => handleSubmit(event) || this.handleFormSubmit(event, errors)}>
                                                ...
                                                <Form.Group as={Col} md='8'>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        onChange={handleChange}
                                                        onBlur={(event) =>
                                                            this.checkEmail(event.target.value, errors) && handleBlur(event)
                                                        }
                                                        isInvalid={!!errors.email && touched.email}
                                                    />
                                                    <Form.Control.Feedback type='invalid'>{errors.email}</Form.Control.Feedback>
                                                    <p id='emailTakenError' className='errorText'>
                                                        {t('errors.emailTaken')}
                                                    </p>
                                                </Form.Group>
                                                <Form.Group as={Col} md='8'>
                            ...
                            <div className='data polaroid last'>
                                <h2 className='title_container'>
                                    {t('profile.titleNewPassword')} {this.state.myPublicationsCounter}
                                </h2>
                                <div className='form'>
                                    <hr />
                                    <Formik
                                        ...
                                        {({values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting}) => (
                                            <Form
                                                noValidate
                                                onSubmit={(event) =>
                                                    handleSubmit(event) || this.handlePasswordFormSubmit(event, errors)
                                                }>
                                                <Form.Group as={Col} md='8'>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        onChange={handleChange}
                                                        onBlur={(event) =>
                                                            this.passwordCheck(event.target.value, errors) && handleBlur(event)
                                                        }
                                                        id='password'
                                                        isInvalid={!!errors.password && touched.password}
                                                    />
                                                    <Form.Control.Feedback type='invalid'>{errors.password}</Form.Control.Feedback>
                                                    <p id='passwordDoNotMatch' className='errorText'>
