...
class Publish extends React.Component {
	...
	previousImage() {
		...
		let newIndex;
		if (this.state.pictures.length <= 1) return;
		if (index - 1 < 0) newIndex = this.state.pictures.length - 1;
	...
	nextImage() {
		...
		let newIndex;
		if (this.state.pictures.length <= 1) return;
		if (index + 1 === this.state.pictures.length) newIndex = 0;
		else newIndex = index + 1;
		var file = new File([this.state.pictures[newIndex]], '', {type: 'image/jpg'});
		this.createPicture(file);
		let count = document.getElementById('countImage');
							...
							<div className='down_box'>
								...
								<div className='image_wrapper'>
									<div className='wrapper_arrows'>
										<span className='arrows arrow-left' onClick={this.previousImage}>
											&#60;
										</span>
									</div>
									...
									<div className='wrapper_arrows'>
										<span className='arrows arrow-right' onClick={this.nextImage}>
											&#62;
										</span>
									</div>
								</div>
