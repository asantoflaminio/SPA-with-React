...
class HomeReal extends React.Component {
   ...
   constructor(props) {
    ...
    render(){
        ...
        let loopEndRent;
        let gridSale;
        if(maxResults > listLengthSale) {
            loopEndSale = listLengthSale;
        } else {
            loopEndSale = maxResults;
        }
        if(maxResults > listLengthRent) {
            loopEndRent = listLengthRent;
        } else {
            loopEndRent = maxResults;
        }
        ...
        /* alquiler */
        let tableRent = [];
        for(let i = 0; i < loopEndRent; i ++) { // desps convertirlo en for each
            tableRent.push(
                <li class="polaroid">
                    <div id="imageDiv_1" class="arrows-div" currentImage="0">
                        <img class="polaroid-property-img" src="data:image/jpeg;base64,"/>	                        
