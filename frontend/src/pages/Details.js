                        ...
                        <div id="left-col">   
                            <div className="polaroid-details">
                                ...
                                <div className="container-list">
                                    <p className="direction">{this.state.publication.address},{this.state.publication.neighborhoodid}, {this.state.publication.cityid},{this.state.publication.provinceid}</p>
                                </div>
                            </div>
