            ...
            <div class="property-container">
                <div class="first-column">								
                    <div class="property-title-container">
                        ...
                        <h4 class="address"> publication.address, publication.neighborhood, publication.city, publication.province</h4>
                    </div>					
                    ...
                    <div class="property-characteristics">
                        ...
                        <div class="column-2">
                            <h4 class="littleCharacteristic"><strong>publication.floorSize</strong> publication.floorSize</h4>	
